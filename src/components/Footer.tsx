    ...
    <footer className="bg-gray-900 text-gray-300 py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold text-white mb-4">Evac<span className="text-evac-orange">4</span>Me</h3>
            <p className="mb-4">Emergency evacuation app designed for everyone, with special attention to accessibility needs.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#collaborate" className="hover:text-white">Collaborate</a></li>
            </ul>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">Contact</h3>
            <p className="mb-2">Email: <a href="mailto:contact@evac4me.com" className="hover:text-white">contact@evac4me.com</a></p>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-sm text-gray-400">
          <div className="flex flex-col md:flex-row justify-between">
            <p>© {new Date().getFullYear()} Evac4Me. A project by Chance4Change. All rights reserved.</p>
